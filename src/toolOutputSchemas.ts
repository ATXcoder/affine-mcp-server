...
const OUTPUT_SPECS = {
  ...
  create_invite_link: spec({ workspaceId: "string", link: "string", expireTime: "string" }),
  ...
  get_blob: fallible(spec({ key: "string", workspaceId: "string", contentType: "string", size: "number", encoding: "string", error: "string" }, true)),
  ...
  grant_member: spec({ workspaceId: "string", userId: "string", email: "nullableString", role: "string", updated: "boolean" }),
  ...
  invite_members: spec({ workspaceId: "string", results: "unknownArray" }),
  ...
  list_workspace_members: spec({ workspaceId: "string", count: "number", members: "unknownArray" }),
  ...
  revoke_invite_link: spec({ workspaceId: "string", revoked: "boolean" }),
  revoke_member: spec({ workspaceId: "string", userId: "string", email: "nullableString", revoked: "boolean" }),
  search_doc_content: spec({ keyword: "string", workspaceId: "string", totalCount: "number", results: "unknownArray" }, true),
