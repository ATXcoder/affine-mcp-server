...
const TOOL_GROUPS: Record<ToolName, readonly string[]> = {
  ...
  create_invite_link: ["workspaces", "users", "users.write", "write"],
  ...
  get_blob: ["blobs", "blobs.read", "read"],
  ...
  get_or_create_journal_doc: ["docs", "docs.write", "write"],
  get_orphan_docs: ["docs", "docs.tree", "docs.read", "read"],
  get_workspace: ["workspaces", "workspaces.read", "read"],
  grant_member: ["workspaces", "users", "users.write", "write"],
  ...
  invite_members: ["workspaces", "users", "users.write", "write"],
  ...
  list_workspace_members: ["workspaces", "users", "users.read", "read"],
  ...
  recover_doc: ["docs", "history", "history.write", "docs.write", "write"],
  ...
  revoke_invite_link: ["workspaces", "users", "users.write", "write"],
  revoke_member: ["workspaces", "users", "users.write", "write"],
  search_doc_content: ["docs", "docs.read", "read"],
